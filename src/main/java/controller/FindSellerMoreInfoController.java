...
public class FindSellerMoreInfoController implements Initializable {
    ...
    private void initData(){
        ...
        moreInfo.setAll( Noise.getNavigation().getFindSellerController().getListAnswer().getListProduct());
    }
}
