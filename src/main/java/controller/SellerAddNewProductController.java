...
public class SellerAddNewProductController extends BaseController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        typeProduct.getItems().addAll("Виброизоляция", "Шумопоглотитель", "Звукоизоляция", "Антискрип");
        classProduct.getItems().addAll("Эконом", "Стандарт", "Премиум");
        typeProduct2.getItems().addAll("Виброизоляция", "Шумопоглотитель", "Звукоизоляция", "Антискрип");
